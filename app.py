...
class TwoPlayer:
    def __init__(self, game_board: Tk) -> None:
        ...
        self.l2 = Button(self.game_board, text="Player 2 : O", width=10,
                         state=DISABLED)
    ...
    def board(self):
        ...
        for r in range(3):
            ...
            for c in range(3):
                ...
                button[r][c] = Button(self.game_board, command=get_t, height=5,
                                      width=10, bd=5)
                n = c + 1
...
class Play:
    def __init__(self) -> None:
        ...
        self.label_title = Label(self.menu, text='TicTacToe', font='Arial 16',
                                 pady=10)
